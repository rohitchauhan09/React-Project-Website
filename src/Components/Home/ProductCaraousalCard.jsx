...
const ProductCaraousalCard = (props) => {
  ...
  return (
    <div className='flex flex-col gap-3 sm:min-w-[252px] sm:min-h-[433px] min-w-231px  relative'>
      ...
      <button onClick={onclick} className=' sm:px-[74px] sm:py-4 px-16 py-[14px] rounded-lg bg-[#141718] absolute sm:bottom-[140px] bottom-[170px] left-3 text-white font-poppins text-sm hover:bg-white hover:text-black hover:border hover:border-black'>Add to Cart</button>
